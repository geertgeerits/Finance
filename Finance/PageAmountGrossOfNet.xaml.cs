namespace Finance
{
    public sealed partial class PageAmountGrossOfNet : ContentPage
    {
        public PageAmountGrossOfNet()
    	{
            ...
            ClassEntryMethods.SetNumberEntryProperties(entPercentage, ClassEntryMethods.cPercDecimalDigits);
            ClassEntryMethods.SetNumberEntryProperties(entAmountNet, ClassEntryMethods.cNumDecimalDigits);
        }
        ...
        private async void CalculateResult(object sender, EventArgs e)
        {
            ...
            // Hide the keyboard
            await ClassEntryMethods.HideSystemKeyboard(entAmountNet);
